package kazinfotech.com.estimotetest;
...
//                postNotification("Entered region");
            ...
            public void onExitedRegion(Region region) {
                postNotification("Вы вышли из кухни");
                Log.d(TAG,"Вы вышли из кухни");
                    ...
                    public void run() {
                       ...
                       for(Beacon beacon:beacons){
                          int major = beacon.getMajor();
                           ...
                           if(beacon.getMajor()==19883&&!majors.contains(major)){
                               majors.add(major);
                               boolean temp = majors.contains(major);
                               postNotification("Вы зашли на кухню");
